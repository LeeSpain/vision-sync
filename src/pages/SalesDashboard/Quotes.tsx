...
export default function Quotes() {
    ...
    const addLineItem = () => {
        setItems([...items, { id: Date.now(), name: "New Add-on Service", type: "Monthly", price: 100 }]);
    };
    ...
    return (
        <div className="space-y-6 animate-fade-in max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Quote Builder</h2>
                    <p className="text-slate-500 dark:text-slate-400 mt-1">
                        Generate and send professional pricing proposals.
                    </p>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="p-6">
                            {/* Setup Fees Section */}
                            <div className="mb-8">
                                <h4 className="text-sm font-semibold uppercase tracking-wider text-slate-500 mb-4 border-b border-slate-100 dark:border-slate-800 pb-2">One-time Setup Fees</h4>
                            ...
                            <div>
                                <h4 className="text-sm font-semibold uppercase tracking-wider text-slate-500 mb-4 border-b border-slate-100 dark:border-slate-800 pb-2">Ongoing Monthly Services</h4>
                                <div className="space-y-3">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6">
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Terms & Notes</h3>
                        <textarea
                            ...
                            defaultValue="Standard 12-month contract commitment applies. Prices exclude VAT. Payment for setup is due upon signature. Monthly subscription begins 30 days post-launch."
                        />
                    </div>
                </div>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 sticky top-24">
                        <div className="p-6 border-b border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900 flex justify-between items-center rounded-t-xl">
                            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Proposal Summary</h3>
                        </div>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="flex justify-between items-end pb-4 border-b border-slate-200 dark:border-slate-800">
                                <div>
                                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Total Setup Cost</p>
                                    <p className="text-2xl font-bold text-slate-900 dark:text-white">${setupTotal.toLocaleString()}</p>
                                </div>
                                <Badge className="bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border-none shadow-none">One-time</Badge>
                            </div>

                            <div className="flex justify-between items-end pb-4 border-b border-slate-200 dark:border-slate-800">
                                <div>
                                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Monthly Subscription</p>
                                    <div className="flex items-baseline gap-1">
                                        <p className="text-3xl font-black text-brand">${monthlyTotal.toLocaleString()}</p>
                                        <span className="text-sm text-slate-500">/mo</span>
                                    </div>
                                </div>
                                <Badge className="bg-brand/10 text-brand border-none shadow-none">Recurring</Badge>
                            </div>
                        ...
                        <div className="p-4 bg-slate-100 dark:bg-slate-800/80 rounded-b-xl border-t border-slate-200 dark:border-slate-700 space-y-3">
                            <Button className="w-full bg-slate-900 hover:bg-slate-800 dark:bg-slate-50 dark:hover:bg-slate-200 dark:text-slate-900 text-white shadow-sm">
                                <CheckCircle2 className="h-4 w-4 mr-2" /> Mark as Accepted
                            </Button>
                        </div>
                    </div>
                </div>
